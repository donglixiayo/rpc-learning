...
对于这个问题，之前我写了一篇文章[《NIO入门》](https://mp.weixin.qq.com/s?__biz=MzU1OTgzNTAzNQ==&mid=2247483835&idx=1&sn=03d35c05c514ca671331e7e117684143&scene=21#wechat_redirect)对NIO有比较详细的介绍，NIO的主要问题是：
...
![图片](https://mmbiz.qpic.cn/mmbiz_png/Rnej1nLQibWCLL8C3m9CyM4EsJibLuNhqJ1iaia5ukZLkyGJg8JibVo5OaIt7YnTmp5pAiaekVfmesGlw79xb2cfhL3Q/640?wx_fmt=png&randomid=zk2i8for&tp=webp&wxfrom=5&wx_lazy=1)
...
![图片](https://mmbiz.qpic.cn/mmbiz/Rnej1nLQibWCLL8C3m9CyM4EsJibLuNhqJO1ZTRPMtMXgibC4ulRvnGsQB8XZPOPcLlczMY6ohibC5fZFBwaghMCXQ/640?wx_fmt=other&randomid=d36ki1m1&tp=webp&wxfrom=5&wx_lazy=1)
...
![图片](https://mmbiz.qpic.cn/mmbiz_png/Rnej1nLQibWCLL8C3m9CyM4EsJibLuNhqJkiaxBxVgNBTBcLayZEJiaTT701haFCoHbualPqn2RDMuky7FRvKlum4g/640?wx_fmt=png&randomid=t9ck75v3&tp=webp&wxfrom=5&wx_lazy=1)

MyClient打印结果：

![图片](https://mmbiz.qpic.cn/mmbiz_png/Rnej1nLQibWCLL8C3m9CyM4EsJibLuNhqJFRYRyE1G9KdZ9PHWHuX6xnW6naib24M2N0ibmRUA7kyib4j8pyjLoHHCA/640?wx_fmt=png&randomid=68pzt43d&tp=webp&wxfrom=5&wx_lazy=1)
...
![图片](https://mmbiz.qpic.cn/mmbiz_png/Rnej1nLQibWCLL8C3m9CyM4EsJibLuNhqJCFEX6pZBuy0nIwKBLrKSo4tArTQIuqjicKTOEOtlkibBeKHLlmPibhqpw/640?wx_fmt=png&randomid=tflqhksr&tp=webp&wxfrom=5&wx_lazy=1)
...
![图片](https://mmbiz.qpic.cn/mmbiz_png/Rnej1nLQibWCLL8C3m9CyM4EsJibLuNhqJ1A3CFnk1dH0KXjPnfqcBiaz3jBaETM14W721SqBBXfnHD8DC1ErWfNg/640?wx_fmt=png&randomid=yw2pufhk&tp=webp&wxfrom=5&wx_lazy=1)
...
![图片](https://mmbiz.qpic.cn/mmbiz_png/Rnej1nLQibWCLL8C3m9CyM4EsJibLuNhqJhbRTqian6zsYnR4VZia3TYYKoGLkf6jHSibMftZfsOm8eRXvEz3OtcVTg/640?wx_fmt=png&randomid=3r9d5js2&tp=webp&wxfrom=5&wx_lazy=1)

可以看出都是继承于AbstractBootStrap抽象类，所以大致上的配置方法都相同。

一般来说，使用Bootstrap创建启动器的步骤可分为以下几步：

![图片](https://mmbiz.qpic.cn/mmbiz_png/Rnej1nLQibWCLL8C3m9CyM4EsJibLuNhqJr5zHYZ6nfD3ib7uAXXHBMo3r74mFzXMX12Lib7CdSibvT9t5cxdkT6ccg/640?wx_fmt=png&randomid=3hgll30v&tp=webp&wxfrom=5&wx_lazy=1)

### 5.4.1 group()

在上一篇文章[《Reactor模式》](https://mp.weixin.qq.com/s?__biz=MzU1OTgzNTAzNQ==&mid=2247483847&idx=1&sn=e890fbf98d69bd76b84c0a024ef1e052&scene=21#wechat_redirect)中，我们就讲过服务端要使用两个线程组：
...
![图片](https://mmbiz.qpic.cn/mmbiz_png/Rnej1nLQibWCLL8C3m9CyM4EsJibLuNhqJhlN1ia9MxEriaImmMSIyI4QdIzGawAxSEKkcWryBCKpFkrVHadbWXqjg/640?wx_fmt=png&randomid=vxhw10um&tp=webp&wxfrom=5&wx_lazy=1)

使用debug模式可以看到

![图片](https://mmbiz.qpic.cn/mmbiz_png/Rnej1nLQibWCLL8C3m9CyM4EsJibLuNhqJY71M7ictoBHeIa0jqvoGNTFJYzVxE7FAfYEOVjlrPKoQcMeuJkAfufw/640?wx_fmt=png&randomid=5aovb8b5&tp=webp&wxfrom=5&wx_lazy=1)
...
>
> **CONNECTION_TIMEOUT_MILLIS** 连接超时时间，超过这个时间还是建立不上的话则代表连接失败。（不设置默认永久等待）
...
在NioEventLoop中，有一个成员变量selector，这是nio包的Selector，在之前[《NIO入门》](https://mp.weixin.qq.com/s?__biz=MzU1OTgzNTAzNQ==&mid=2247483835&idx=1&sn=03d35c05c514ca671331e7e117684143&scene=21#wechat_redirect)中，我已经讲过Selector了。

Netty中的Selector也和NIO的Selector是一样的，就是用于监听事件，管理注册到Selector中的channel，实现多路复用器。

![图片](https://mmbiz.qpic.cn/mmbiz_png/Rnej1nLQibWCLL8C3m9CyM4EsJibLuNhqJCevTnC3t9LTMmqjhkYicvuff7SRkFWzpKrVicouD9WwbiatfP7I9XAT7w/640?wx_fmt=png&randomid=5o1p1qc9&tp=webp&wxfrom=5&wx_lazy=1)
...
![图片](https://mmbiz.qpic.cn/mmbiz_png/Rnej1nLQibWCLL8C3m9CyM4EsJibLuNhqJEiaNEvlvO12pRUPiauGYPOWJpWNR0ia0MyYs5Yb4Bx3FHb16dOlQ3icibRQ/640?wx_fmt=png&randomid=ipoig1db&tp=webp&wxfrom=5&wx_lazy=1)
...
![图片](https://mmbiz.qpic.cn/mmbiz_png/Rnej1nLQibWCLL8C3m9CyM4EsJibLuNhqJ4Scw6PQzBrxSzIiasJ8emZYab4ZtmibjuictW7831gPYEeNyg505cA7zA/640?wx_fmt=png&randomid=9wz1zdwc&tp=webp&wxfrom=5&wx_lazy=1)
...
![图片](https://mmbiz.qpic.cn/mmbiz_png/Rnej1nLQibWCLL8C3m9CyM4EsJibLuNhqJic1DNf7SlMNIVUSQCLBy5rPdEnfr1NnvweX1mBUabHV1c2EicYgO2mdg/640?wx_fmt=png&randomid=8dp9st0p&tp=webp&wxfrom=5&wx_lazy=1)

## 5.9 EventLoopGroup

我们先看一下EventLoopGroup的类图：

![图片](https://mmbiz.qpic.cn/mmbiz_png/Rnej1nLQibWCLL8C3m9CyM4EsJibLuNhqJplH7PgGicDZbTicSic5G3gBSiaamdc64wgnWBIu6Valk2snFhR8qPnudww/640?wx_fmt=png&randomid=ysiocm63&tp=webp&wxfrom=5&wx_lazy=1)
...
![图片](https://mmbiz.qpic.cn/mmbiz_png/Rnej1nLQibWCLL8C3m9CyM4EsJibLuNhqJ3bf71358kW3wygibI9OlGJyFICSxichv3FEyuWy9BSzFibHickymHzj2Aw/640?wx_fmt=png&randomid=ycapkpw0&tp=webp&wxfrom=5&wx_lazy=1)
